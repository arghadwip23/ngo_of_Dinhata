  ...
  return (
	...
	<div className="container mx-auto space-y-12">
		<div className="flex flex-col overflow-hidden rounded-md shadow-md lg:flex-row">
			<img src="https://picsum.photos/1000" alt="" className="h-80 bg-gray-500 aspect-video" />
		...
		<div className="flex flex-col overflow-hidden rounded-md shadow-md lg:flex-row-reverse">
			<img src="https://picsum.photos/200" alt="" className="h-80 bg-gray-500 object-contain aspect-video" />
