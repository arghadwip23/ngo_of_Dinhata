...
export default function Hero() {
 const urlEndpoint = process.env.NEXT_PUBLIC_URL_ENDPOINT;
  ...
  return (
    <section className="flex  md:px-20 md:pt-0  md:h-2/3 bg-zinc-50 flex-col items-center  border-red-200 w-screen space-y-0 h-screen p-0 md:flex-row items-center p-0 justify-between bg-white">
      {/* Left Side: Text */}
      ...
      <IKImage urlEndpoint={urlEndpoint} path="hero.png" width={500} height={500} alt="Alt text" className='' />
      </div>
    </section>
  )
}
