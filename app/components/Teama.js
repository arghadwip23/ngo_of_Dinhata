...
export default function Teama() {
  return (
    <div class="font-[sans-serif] max-w-5xl max-lg:max-w-4xl  max-sm:max-w-sm mx-auto mt-4">
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-6 gap-y-16 text-center mt-24">
                ...
                <div class="bg-gray-200 relative rounded">
                    ...
                    <div class="py-4">
                        <h4 class="text-gray-800 text-base font-extrabold">Mark Adair</h4>
                        <p class="text-gray-800 text-xs mt-1">Software Engineer</p>
                ...
                <div class="bg-gray-200 relative rounded">
                    ...
                    <div class="py-4">
                        <h4 class="text-gray-800 text-base font-extrabold">Simon Konecki</h4>
                ...
                <div class="bg-gray-200 relative rounded">
                    ...
                    <div class="py-4">
                        <h4 class="text-gray-800 text-base font-extrabold">Eleanor</h4>
                        <p class="text-gray-800 text-xs mt-1">Web Designer</p>
